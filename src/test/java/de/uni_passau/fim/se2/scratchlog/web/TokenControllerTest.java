...
import de.uni_passau.fim.se2.scratchlog.web.controller.TokenController;
...
public class TokenControllerTest {
    ...
    private final UserDTO userDTO = new UserDTO("admin", "admin1@admin.de", Role.ADMIN, Language.ENGLISH, "admin",
            "secret1");
