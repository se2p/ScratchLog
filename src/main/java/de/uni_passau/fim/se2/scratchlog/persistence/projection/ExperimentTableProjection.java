...
/**
 * Projection interface for the {@link de.uni_passau.fim.se2.scratchlog.persistence.entity.Experiment} class to return
 * only the id, title, description, and status.
 */
