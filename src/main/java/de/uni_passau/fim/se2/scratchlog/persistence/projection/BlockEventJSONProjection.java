...
/**
 * Projection interface for the {@link de.uni_passau.fim.se2.scratchlog.persistence.entity.BlockEvent} class to return
 * only the block event id, timestamp and the json code.
 */
