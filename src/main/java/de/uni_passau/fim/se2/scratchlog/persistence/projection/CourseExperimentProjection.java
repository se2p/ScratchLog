...
/**
 * Projection interface for the {@link de.uni_passau.fim.se2.scratchlog.persistence.entity.CourseExperiment} class to
 * return only the experiment id, title, description, and status.
 */
